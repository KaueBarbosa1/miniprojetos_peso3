...
from circulo.cliente.icirculo_operations_manager import ICirculoOperationsManager
from circulo.cliente.icirculos_manager import ICirculosManager
from circulo.cliente.icontatos_manager import IContatosManager
